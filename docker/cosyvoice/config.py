...
REGISTER_SPK_INFO_DICT = {
    "兰溪": {
        "prompt_text": "看到是胡桃带你们来的，我也就安心了，只是这地方什么都没有，也难做什么招待",
        "prompt_audio_path": "/var/lib/cosyvoice/workspace/CosyVoice/voice/vo_dialog_HTLQ004_lanxi_02.wav",
    },
    "丝柯克": {
        "prompt_text": "谢谢你们帮忙「善后」，这本来应该是我的工作。",
        "prompt_audio_path": "/var/lib/cosyvoice/workspace/CosyVoice/voice/vo_FDAQ306_13_skirk_01.wav",
    },
    "久保": {
        "prompt_text": "哼，我们只听命于老爷，也只为老爷负责",
        "prompt_audio_path": "/var/lib/cosyvoice/workspace/CosyVoice/voice/vo_LRLQ002_1_kubo_02.wav",
    },
    "可莉": {
        "prompt_text": "这个工坊，可莉知道该怎么用！",
        "prompt_audio_path": "/var/lib/cosyvoice/workspace/CosyVoice/voice/vo_mimiTomo_md_klee_alchemy_01.wav",
    },
    "凯亚": {
        "prompt_text": "真是和平啊，可又能持续多久呢？",
        "prompt_audio_path": "/var/lib/cosyvoice/workspace/CosyVoice/voice/vo_kaeya_weather_breezy_01.wav",
    },
    "伽吠毗陀": {
        "prompt_text": "你的秘典之盒…我一直都带在身边…",
        "prompt_audio_path": "/var/lib/cosyvoice/workspace/CosyVoice/voice/vo_DPEQ004_8_garvipidam_34.wav",
    },
    "哈里森": {
        "prompt_text": "我真是受够你们的欺负了，这件事可没那么容易就算了！",
        "prompt_audio_path": "/var/lib/cosyvoice/workspace/CosyVoice/voice/vo_DQAQ002_17_harrison_03.wav",
    },
    "卡维": {
        "prompt_text": "太阳晒久了就想睡觉，跟熬夜工作的感觉差不多，都是头晕。",
        "prompt_audio_path": "/var/lib/cosyvoice/workspace/CosyVoice/voice/vo_kaveh_weather_sunny_01.wav",
    },
}
